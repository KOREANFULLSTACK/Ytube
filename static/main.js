...
eval("var recorderContainer = document.getElementById(\"recorderContainer\");\nvar recordBtn = document.getElementById(\"recordStartButton\");\nvar videoPreview = document.getElementById(\"videoPreview\");\n\nfunction startRecording() {\n  var stream;\n  return regeneratorRuntime.async(function startRecording$(_context) {\n    while (1) {\n      switch (_context.prev = _context.next) {\n        case 0:\n          _context.prev = 0;\n          _context.next = 3;\n          return regeneratorRuntime.awrap(navigator.mediaDevices.getUserMedia({\n            audio: true,\n            video: true\n          }));\n\n        case 3:\n          stream = _context.sent;\n          console.log(stream);\n          _context.next = 11;\n          break;\n\n        case 7:\n          _context.prev = 7;\n          _context.t0 = _context[\"catch\"](0);\n          recordBtn.innerHTML = \"Can't record\";\n          recordBtn.removeEventListener(\"click\", startRecording);\n\n        case 11:\n        case \"end\":\n          return _context.stop();\n      }\n    }\n  }, null, null, [[0, 7]]);\n}\n\nfunction init() {\n  recordBtn.addEventListener(\"click\", startRecording);\n}\n\nif (recorderContainer) {\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/videoRecorder.js?");
